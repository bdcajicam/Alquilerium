...
@Api(name = "reservaendpoint", namespace = @ApiNamespace(ownerDomain = "edu.co", ownerName = "edu.co", packagePath = "unal.isii.client") )
public class ReservaEndpoint {
	...
	public CollectionResponse<Reserva> listReserva(@Nullable @Named("cursor") String cursorString,
		...
		return CollectionResponse.<Reserva> builder().setItems(execute).setNextPageToken(cursorString).build();
	}
